...
#
{
  ...
  mkBcrCaches =
    ...
    let
      ...
      # http_archive repos generated by module extensions (e.g. rules_rust's
      # process_wrapper crate "tinyjson", or crate_universe crates). These are
      ...
      extensionArchives =
        let
          ...
          toArchive =
            ...
            in
            if (spec.ruleClassName or "") == "http_archive" && url != null && sha256 != null then
              { inherit url sha256; }
            else
              null;
        in
